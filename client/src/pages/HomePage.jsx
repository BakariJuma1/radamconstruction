      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20 md:py-28">
        <div className="container mx-auto px-4 md:px-8 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Building Excellence, <br className="hidden md:block" /> Crafting Legacy
          </h1>
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-90">
            Professional construction services with over 10 years of experience delivering quality projects on time and within budget.
          </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 items-center opacity-60">
            {['Bamburi cement', 'Doshi', 'Simba cement', 'Lakhir plastics', 'Basco paints'].map((company, index) => (
              <div key={index} className="text-xl font-semibold text-gray-700">{company}</div>
            ))}
          </div>
        </div>
      </section>
          ...
          {loadingServices ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {services.map(service => (
                <div key={service.id} className="group bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl border border-gray-100">
                  <div className="relative overflow-hidden h-48 bg-gray-100 flex items-center justify-center">
                    <div className="text-blue-600 text-5xl opacity-20">
          ...
          {loadingPortfolio ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {portfolio.map((project, index) => (
                <div key={project.id} className="bg-white rounded-lg shadow-md overflow-hidden group border border-gray-100">
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="p-4">
              ...
              <div className="text-lg uppercase tracking-wider text-blue-200">Projects Completed</div>
            </div>
            <div className="p-4">
              <div className="text-4xl md:text-5xl font-bold mb-2">10+</div>
              <div className="text-lg uppercase tracking-wider text-blue-200">Years Experience</div>
            </div>
            <div className="p-4">
              <div className="text-4xl md:text-5xl font-bold mb-2">50+</div>
              <div className="text-lg uppercase tracking-wider text-blue-200">Expert Workers</div>
            </div>
            <div className="p-4">
              <div className="text-4xl md:text-5xl font-bold mb-2">98%</div>
              <div className="text-lg uppercase tracking-wider text-blue-200">Happy Clients</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 md:px-8 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-blue-600 mx-auto"></div>
            <p className="text-gray-600 mt-6 max-w-2xl mx-auto">
              A structured approach to ensure quality and efficiency in every project we undertake
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              { title: "Planning", desc: "Detailed project planning and design" },
              { title: "Execution", desc: "Quality construction with precision" },
            ...
            {[1, 2, 3].map((item) => (
              <div key={item} className="bg-white p-8 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 mb-6 italic">
                  "Radamjaribu Builders transformed our home beyond expectations. Their attention to detail and professional approach made the entire process smooth and stress-free."
                </p>
